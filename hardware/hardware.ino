...
#define DATA_PIN 22 // Need to change later
#define DHTPIN 27
#define DHTTYPE DHT22


// MQTT CLIENT CONFIG
// Keep these topics aligned with the frontend Control page + backend MQTT subscriber.
static const char* pubtopic      = "620171008";                     // Device topic (sensor updates)
static const char* subtopic[]    = {"620171008_sub","/elet2415"};   // Control topic + course topic
static const char* mqtt_server   = "www.yanacreations.com";         // Broker IP address or Domain name as a String 
static uint16_t mqtt_port        = 1883;

// WIFI CREDENTIALS
const char* ssid       = "138SL-Residents.";     // Add your Wi-Fi ssid
const char* password   = "resident2020@138sl"; // Add your Wi-Fi password 
